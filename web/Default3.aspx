            ...
            <table border ="3" width ="1200">
                <tr>
                    <td width="600" align ="center" height="660">
                        <%--<asp:Image ID="tu" runat="server" Height="650px" Width="600px" ImageUrl="~/web/image/北京1.jpg" />--%>
                        <img src="image/北京1.jpg" style="height:650px;width:600px;" ID="tu" runat="server"/>
                    </td>
