...
<ul >
  ...
  <li>
   ...
   <h2 >友情链接</h2>
   <ul type="disc">
   <li ><a href ="#" ><img src ="image/康辉logo.png" alt="" width ="110" height ="32" /></a></li>
   </ul>
   </li>
</ul>
</div>
...
<div class="gundong">
<marquee direction="up" behavior="scroll" class="qqq" scrollamount="3"width="200" height="300" bgcolor="#CCCCCC" hspace="0" vspace="0">公告<br />04月16日00时25分在日本九州岛发生7.3级地震，震源深度10千米，地震发生后中青旅紧急联系在日本的中青旅游客团，经确认，目前有20人旅游团虽身处震中，但都安全无虞，同时中青旅遨游网及日本中青旅，与当地救援队伍密切配合，正全力协助客人转移.</marquee>
<br/><br/>
...
&nbsp;<%--<asp:DataList 
    ...
    <table>
        <tr>
            <td>
                <img src="remen/y1.jpg" /></td>
            <td>
                <img src="remen/y2.jpg" /></td>
            <td>
                <img src="remen/y3.jpg" /></td>
        </tr>
        <tr>
            <td><版纳壹号>北京出发 昆明 版纳 <br />老挝磨丁三飞五晚六日跟团游2980起</td>
            <td><王者归来>北京往返 云南昆明+大理+<br />丽江双飞5晚6日VIP奢华五钻之旅跟团<br />游2980起</td>
            <td><大师荟>北京往返 云南昆明+大理<br />+丽江双飞5晚6天跟团游3090起</td>
        </tr>
    </table>
...
<a name="abeijing"><img src ="image/北京标题.png" alt ="" /><br /></a>
   <%-- <asp:DataList ID="DataList2" runat="server" CellSpacing="100" 
    ...
    <table>
        <tr>
            <td>
                <img src="remen/b1.jpg" /></td>
            <td>
                <img src="remen/b2.jpg" /></td>
            <td>
                <img src="remen/b3.jpg" /></td>
        </tr>
        <tr>
            <td><佛山出发>广州往返北京一地双飞<br />三星标准特惠5晚6天跟团游1499起</td>
            <td><佛山出发>广州往返北京一地双飞<br />三星标准特惠6晚7天跟团游1599起</td>
            <td><佛山出发>广州往返北京一地双飞<br />三星标准特惠8晚9天跟团游1699起</td>
        </tr>
    </table>
    <br />
</div>
